...
const BigCrystal = () => {
  ...
  return (
    <Icosahedron ref={ref} args={[1.6, 1]}>
      {/* @ts-ignore */}
      <MeshTransmissionMaterial thickness={1.5} roughness={0.04} transmission={1} ior={1.45} chromaticAberration={0.08} backside color="#22d3ee" />
    </Icosahedron>
  );
};
...
export const AboutCrystal = () => (
  <div className="h-72 md:h-96 w-full rounded-2xl overflow-hidden bg-gradient-hero border shadow-elegant">
    <Canvas camera={{ position: [0, 0, 5], fov: 45 }} dpr={[1, 1.5]}>
      ...
      <directionalLight position={[-5, -3, 2]} intensity={0.6} color="#67e8f9" />
