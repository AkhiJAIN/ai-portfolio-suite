    ...
    <Section id="contact" eyebrow="Say hello" title="Let's work together">
      <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground mb-6">Always open to interesting projects, collaborations, or just a chat about AI.</p>
          <div className="space-y-3">
            <a href={`mailto:${profile.email}`} className="flex items-center gap-3 rounded-xl p-3 hover:bg-secondary transition-smooth">
              ...
              <div><p className="text-xs text-muted-foreground">Email</p><p className="font-medium text-sm break-all">{profile.email}</p></div>
            </a>
            <a href={profile.linkedin} className="flex items-center gap-3 rounded-xl p-3 hover:bg-secondary transition-smooth">
              ...
              <div><p className="text-xs text-muted-foreground">LinkedIn</p><p className="font-medium text-sm break-all">{profile.linkedin}</p></div>
            </a>
            <a href={profile.github} className="flex items-center gap-3 rounded-xl p-3 hover:bg-secondary transition-smooth">
              ...
              <div><p className="text-xs text-muted-foreground">GitHub</p><p className="font-medium text-sm break-all">{profile.github}</p></div>
            </a>
          </div>
        </motion.div>
        ...
        >
          <div><label className="text-sm font-medium mb-1.5 block">Name</label><Input required name="name" placeholder="Your name" maxLength={100} /></div>
          <div><label className="text-sm font-medium mb-1.5 block">Email</label><Input required type="email" name="email" placeholder="you@example.com" maxLength={255} /></div>
          <div><label className="text-sm font-medium mb-1.5 block">Message</label><Textarea required name="message" placeholder="Tell me about your project..." rows={5} maxLength={1000} /></div>
