...
export const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-24 pb-12 bg-gradient-hero overflow-hidden">
      <div className="container grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          <div className="relative">
            <div className="absolute -inset-4 rounded-full bg-gradient-primary opacity-30 blur-2xl animate-float" />
